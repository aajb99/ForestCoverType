...
boost_results3 <- fit_resamples(boost_wf,
                                resamples = folds,
                                metrics = metric_set(roc_auc),
                                control = tuned_model)
...
save(file = 'RFFinal.RData', list = c('rf_results3'))
save(file = 'BoostFinal.RData', list = c('boost_results3'))
# save(file = 'NNFinal.RData', list = c('nn_results3 '))
